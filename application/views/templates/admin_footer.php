...
<!-- Page level plugins -->
<script src="<?= base_url('back-end/') ?>vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?= base_url('back-end/') ?>vendor/datatables/dataTables.bootstrap4.min.js"></script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#tabelAsistenDosen').DataTable();
        $('#tabelAkunDosen').DataTable();
        $('#tabelKurikulum').DataTable();
        $('#tabelSemester').DataTable();
        $('#tabelProfilLulusan').DataTable();
        $('#tabelCapaianPembelajaran').DataTable();
    });
</script>
